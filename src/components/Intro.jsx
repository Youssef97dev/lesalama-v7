...
const Intro = () => {
  return (
    <div
      className="w-full h-[60vh] flex flex-col justify-center items-center bg-cover bg-center mt-2 px-7 gap-4"
      style={{
        backgroundImage:
    ...
    >
      ...
      <p className="text-base lg:text-lg text-center text-white">
